const cityInput = document.querySelector('.plc');
const mainCard = document.querySelector('.mainCard')
const form = document.querySelector('.form')
const apiKey = "5d1473e740c3902815005330e3caf941";
...
function getApiData() {
    ...
    .then((data) => {
        ...
        mainCard.remove()
        if (!cityName) {
          weatherInfo.innerHTML = `<p class="error">Please enter a city.</p>`;
          return;
      }
...
<div class="cardm">
  ...
  <div class="card2">
    <div class="upper">
      ...
      <div class="air">
        <div class="airtext">Wind<br>${wind}</div>
    ...
    <div class="lower">
      <div class="aqi">
        ...
        <div class="aqitext">Sky<br>${description}</div>
      </div>
      ...
      <div class="realfeel">
        ...
        <div class="realfeeltext">Real Feel<br>${realFeel}°C</div>
      </div>
